...
defaultproperties
{
     ...
     Description="The use of explosive or heavy weaponry, including flamethrowers, LAWs, and the experimental plasma and GEP guns, in addition to various grenades.|n|nUNTRAINED: An agent can use heavy weaponry, but with difficult movement. An agent can also throw grenades, attach them to a surface as a proximity device, or attempt to disarm and remove a previously armed proximity device.|n- GEP Gun takes 2 seconds to lock on.|n- The safety margin for disarming proximity devices is 1 second.|n|nTRAINED:|n+20% damage, +5% accuracy, and -10% reload time.|n- GEP Gun takes 1.7 seconds to lock on.|n- The safety margin is 2 seconds.|n|nADVANCED: An agent can move swiftly with heavy weapons.|n+50% damage, +12.5% accuracy, and -25% reload time.|n- GEP Gun takes 1.25 seconds to lock on.|n- The safety margin is 5 seconds.|n|nMASTER: An agent is an expert in all forms of destruction.|n+100% damage, +25% accuracy, and -50% reload time.|n- GEP Gun takes 0.5 seconds to lock on.|n- The safety margin is 10 seconds."
