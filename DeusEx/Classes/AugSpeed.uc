...
defaultproperties
{
     ...
     Description="Ionic polymeric gel myofibrils are woven into the leg muscles, increasing the speed at which an agent can run and climb, the height they can jump, and reducing the damage they receive from falls.|n|nProduces noises over a large area when moving.|n|nMovement Speed: +20% / 40% / 60% / 80%|nJump Height: +20% / 40% / 60% / 80%|nFall Damage Reduction: 10 / 20 / 40 / 80|n|nEnergy Rate: 0.4 / 0.5 / 0.6 / 0.7 per second"
