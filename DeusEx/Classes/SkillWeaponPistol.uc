...
defaultproperties
{
     ...
     Description="The use of standard weaponry.|n|nAffects: Pistol, Assault Rifle, Sawed-Off Shotgun, Assault Shotgun.|n|n[UNTRAINED]|nAn agent can use standard guns.|n|n[TRAINED]|n<Pistol>|n+15% accuracy|n+50% stability|n|n<Sawed-Off Shotgun>|n+10% accuracy|n+25% stability|n-50% reload time|n|n<Assault Rifle>|n+10% accuracy|n|n[ADVANCED]|n<Pistol>|n+20% accuracy|n+75% stability|n|n<Assault Rifle>|n+15% accuracy|n+50% stability|n|n<Sawed-Off Shotgun>|n+20% accuracy|n+50% stability|n|n<Assault Shotgun>|n+15% accuracy|n+25% stability|n-25% reload time|n|n[MASTER]|nAn agent is a street sweeper.|n<Assault Rifle>|n+25% accuracy|n|n<Assault Shotgun>|n+20% accuracy|n+50% stability|n-50% reload time"
