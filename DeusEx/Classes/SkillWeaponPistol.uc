...
defaultproperties
{
     ...
     Description="The use of standard weaponry.|n|nAffects: Pistol, Assault Rifle, Sawed-Off Shotgun, Assault Shotgun.|n|nUNTRAINED: An agent can use standard guns.|n|nTRAINED:|nPistol:|n+20% accuracy|n+50% stability|nSawed-Off Shotgun:|n+10% accuracy|n+25% stability|n-50% reload time|n|nADVANCED:|nPistol:|n+75% stability.|nAssault Rifle:|n+15% accuracy|n+50% stability|nSawed-Off Shotgun:|n+20% accuracy|n+50% stability|nAssault Shotgun:|n+15% accuracy|n+25% stability|n-25% reload time|n|nMASTER: An agent is a street sweeper.|nAssault Rifle:|n+25% accuracy|nAssault Shotgun:|n+20% accuracy|n+50% stability|n-50% reload time"
