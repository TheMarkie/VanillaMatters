...
native(2300) static final function int UpgradeValueArrayCount( array<UpgradeValue> A );
static final preoperator int #( out array<UpgradeValue> A ) { return UpgradeValueArrayCount( A ); }

// UpgradeCategory array support
native(2300) static final function int UpgradeCategoryArrayCount( array<UpgradeCategory> A );
