...
defaultproperties
{
     ...
     Description="Sorting rotors accelerate calcium ion concentration in the sarcoplasmic reticulum, increasing an agent's muscle speed several-fold and enhancing their combat prowess and speed.|n|nMelee Damage: +25% / 50% / 75% / 100%|nMelee Attack Speed: +10% / 20% / 30% / 40%|nReload Time: -10% / 20% / 30% / 40%|nInjury Accuracy Penalty: -10% / 20% / 30% / 40%|n|nEnergy Rate: 0.4 per second"
     InstallLocation=AugmentationLocationArm
     Rates=(0.4,0.4,0.4,0.4)
