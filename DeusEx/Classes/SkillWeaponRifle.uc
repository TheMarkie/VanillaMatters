...
defaultproperties
{
     ...
     Description="The use of specialist weaponry.|n|nAffects: Mini-Crossbow, Stealth Pistol, Sniper Rifle.|n|n[UNTRAINED]|nAn agent can use precision weapons.|n|n[TRAINED]|n<Mini-Crossbow>|n+25% damage|n+15% accuracy|n-50% reload time|n|n<Stealth Pistol>|n+20% damage|n+10% accuracy|n+20% stability|n|n<Sniper Rifle>|n+20% damage|n+10% accuracy|n|n[ADVANCED]|n<Mini-Crossbow>|n+50% damage|n+25% accuracy|n|n<Stealth Pistol>|n+40% damage|n+15% accuracy|n+40% stability|n|n<Sniper Rifle>|n+50% damage|n+15% accuracy|n|n[MASTER]|nAn agent can take down a target a mile away with one shot.|n<Stealth Pistol>|n+20% accuracy|n|n<Sniper Rifle>|n+100% damage|n+25% accuracy"
