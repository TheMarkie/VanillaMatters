...
defaultproperties
{
     ...
     UpgradeName="D.A.S.H"
     Description="Displacement Assisted by Supercharged Hypercapacitors utilizes a system of fast-charging, high-output capacitors installed across the agent's back to generate a controlled electromagnetic blast behind the agent, propeling them forward for a short distance.|n|nEnergy Cost: 12 / 10 / 8 / 4 per activation|nCooldown: 5 / 4 / 3 / 1 seconds"
