...
defaultproperties
{
     ...
     UpgradeName="D.A.S.H"
     Description="Displacement Assisted by Supercharged Hypercapacitors utilizes a system of fast-charging, high-output capacitors installed across the agent's back to generate a controlled electromagnetic blast behind the agent, propeling them forward for a short distance.|n|nEnergy Rate: 10 / 8 / 6 / 4 per activation|nCooldown: 4 / 3 / 2 / 1 seconds"
