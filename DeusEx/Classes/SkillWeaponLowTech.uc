...
defaultproperties
{
     ...
     GlobalValues=((Name="MeleeWeaponDamage",Values=(0,0.2,0.5,1)),(Name="WeaponProdDamage",Values=(0,0.2,0.5,1)),(Name="WeaponPepperGunDamage",Values=(0,0.2,0.5,1)),(Name="WeaponShurikenDamage",Values=(0,0,0.5,1)),(Name="WeaponShurikenAccuracy",Values=(0,0,0.15,0.25)))
}
