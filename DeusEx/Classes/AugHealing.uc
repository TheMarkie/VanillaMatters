...
defaultproperties
{
     ...
     Description="Programmable polymerase automatically directs construction of proteins in injured cells, restoring an agent to full health over time.|n|nHeal: 10 / 20 / 30 / 40 HP per second|n|nEnergy Rate: 0.5 / 1 / 1.5 / 2 per second healed"
