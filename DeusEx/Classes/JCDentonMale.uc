...
defaultproperties
{
     StartingSkills=(class'DeusEx.SkillWeaponPistol',class'DeusEx.SkillWeaponRifle',class'DeusEx.SkillWeaponHeavy',class'DeusEx.SkillWeaponLowTech',class'DeusEx.SkillEnviro',class'DeusEx.SkillMedicine',class'DeusEx.SkillTech',class'DeusEx.SkillLockpicking',class'DeusEx.SkillComputer')
