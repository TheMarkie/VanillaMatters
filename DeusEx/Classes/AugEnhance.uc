...
defaultproperties
{
     ...
     Description="Nanite bioworkers reinforce and improve body tissue bioprocesses, enhancing the agent's physical performance as well as self regenerative capability.|n|nGain bonuses as long as energy is above threshold. The higher above threshold, the better the bonuses.|nBonuses increase every 10% energy.|n|nBase Energy Threshold: 80% / 70% / 60%|nMovement Speed: +10% per threshold|nMax Movement Speed: 20% / 30% / 40%|nHeal: 6 + 2 / 4 / 6 HP per second|nMax Heal: 8 / 14 / 22 HP per second"
