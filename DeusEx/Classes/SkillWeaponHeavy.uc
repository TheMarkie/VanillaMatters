...
defaultproperties
{
     ...
     GlobalValues=((Name="HeavyWeaponMovementSpeedBonus",Values=(0,0.25,0.5)),(Name="WeaponGEPGunHoming",Values=(0,1)),(Name="WeaponGEPGunReloadTime",Values=(0,-0.25,-0.5,-0.9)),(Name="WeaponGEPGunLockTime",Values=(0,0,-0.5)),(Name="WeaponFlamethrowerReloadTime",Values=(0,-0.5,-0.75)),(Name="WeaponPlasmaRifleReloadTime",Values=(0,0,0,-0.75)))
     CategoryValues=((Name=Accuracy,Values=((Name=WeaponGEPGun,Values=(0,0,0.25)),(Name=WeaponPlasmaRifle,Values=(0,0,0.1,0.2)))),(Name=Stability,Values=((Name=WeaponPlasmaRifle,Values=(0,0,0.2,0.4)))))
}
