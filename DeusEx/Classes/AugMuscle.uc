...
defaultproperties
{
     ...
     Description="Muscle strength is amplified with ionic polymeric gel myofibrils that allow the agent to push and lift extraordinarily heavy objects.|n|nTECH ONE: Strength is increased by 100%.|n- The agent can turn any object into a lethal missile with a powerthrow.|n(Powerthrow damage is relative to strength)|n+25% thrown weapon speed and distance.|n-10% accuracy penalty from arm injuries.|n|nTECH TWO: Strength is increased by 200%.|n+50% thrown weapon speed and distance.|n-20% accuracy penalty.|n|nTECH THREE: Strength is increased by 300%.|n+75% thrown weapon speed and distance.|n-30% accuracy penalty.|n|nTECH FOUR: An agent is inhumanly strong. Strength is increased by 400%.|n+100% thrown weapon speed and distance.|n-40% accuracy penalty.|n|nStarts draining energy when a heavy object is held or a powerthrow is performed, drain rate depends on the object's mass."
