...
static final preoperator int #( out array<byte> A ) { return ByteArrayCount( A ); }
static final preoperator int #( out array<float> A ) { return FloatArrayCount( A ); }
...
static final preoperator bool !( out array<int> A ) { return IntArrayCount( A ) <= 0; }
static final preoperator bool !( out array<byte> A ) { return ByteArrayCount( A ) <= 0; }
static final preoperator bool !( out array<float> A ) { return FloatArrayCount( A ) <= 0; }
